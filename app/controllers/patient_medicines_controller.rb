...
class PatientMedicinesController < ApplicationController # rubocop:disable Style/Documentation
  before_action :set_patient_medicine, only: %i[show update destroy]
